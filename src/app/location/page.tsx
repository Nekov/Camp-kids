...
const amenities = [
  { icon: "🏕️", title: "Глемпинг палатки", desc: "Просторни палатки с климатик, удобни легла, топли завивки и шкафове за съхранение на багаж." },
  { icon: "🚿", title: "Лична баня", desc: "Всяка палатка разполага със собствена санитарна единица — душ, тоалетна, мивка." },
  { icon: "🍳", title: "Кухня и трапезария", desc: "Прясна храна, приготвена на място всеки ден. Три основни хранения и две закуски дневно." },
  { icon: "🏊", title: "Басейн", desc: "Открит басейн, достъпен през свободното време." },
  { icon: "☀️", title: "Открити ателиета", desc: "Специално оборудвани пространства за творческа работа на открито." },
  { icon: "🔥", title: "Лагерен огън", desc: "Вечерни събирания около огъня с разговори, музика и смях." },
  { icon: "🎬", title: "Лятно кино", desc: "Прожекции под открито небе." },
  { icon: "📡", title: "Свързаност", desc: "Добър обхват на телефона и бърз интернет из цялото пространство." },
];
        ...
        <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-10">
            <div className="space-y-4 text-moss text-base leading-relaxed">
              ...
              <p>
                Комбинацията от луксозен глемпинг и природна автентичност е нашата формула:
        ...
        <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            ...
            <div className="space-y-3 text-moss text-sm leading-relaxed">
              ...
              <p><strong className="text-forest">Точна локация:</strong> GPS координати: 42.93457993730604, 24.983541741546176 или просто потърсете Stolat Camp в Google Maps.</p>
