    ...
    items: [
      {
        ...
        a: `Екипът е международен — някои от работилниците се провеждат на чужд език с осигурен преводач. В лагера участват и деца от други страни: тази година очакваме участници от Германия.`,
      },
      {
        q: "Мога ли да ползвам собствен транспорт?",
        a: "Да. Отбележете това в регистрационната форма и цената на лагера ще бъде намалена с 20 лв.",
      },
      {
        q: "Защо родителите трябва лично да приберат детето в последния ден?",
        a: "Присъствието на родителя в последния ден е важно. Децата са изградили театрална постановка и художествена изложба. Родителят трябва да бъде там, за да отпразнуват заедно постижението и да споделят преживяното.",
      },
      {
        q: "Как е организирано настаняването?",
        a: "Участниците са настанени в стаи с 2–4 легла, всяка с лична баня и тоалетна.",
      },
      {
        q: "Какво да взема детето си?",
        a: "Носете практични и издръжливи дрехи, подходящи за игра на открито: пластове облекло, затворени обувки, бански, слънцезащита и дъждобран. Децата работят с бои и прекарват много време навън.",
      },
      {
        q: "Трябва ли да дам лекарства?",
        a: "Носете лекарствата, които детето взима редовно. Лагерът разполага с основна аптечка за леки наранявания и неразположения.",
      },
      {
        q: "Има ли пране на дрехи?",
        a: "Да, участниците могат да перат дрехите си на място по времето на 13-дневния лагер.",
      },
      {
        q: "Могат ли приятели да са в една стая?",
        a: "Не. Лагерът поставя приоритет на изграждането на нови приятелства и избягва затварянето на вече съществуващи групи.",
      },
      {
        q: "Могат ли братя и сестри да са в една стая?",
        a: "Възможно е, ако раздялата би причинила емоционален стрес. Отбележете тази загриженост при регистрацията.",
      },
      {
        q: "Може ли да се удовлетворят специални хранителни нужди?",
        a: "Да. Споделете хранителните изисквания на детето ви при регистрацията — лагерът може да се съобрази с разумни нужди.",
      },
      {
        q: "Трябва ли детето да има лични пари?",
        a: "Не е необходимо — храната, напитките и всички активности са включени. Ако давате пари, моля уведомете организаторите.",
      },
      {
        q: "Защо не се ползват телефони по време на лагера?",
        a: `Офлайн философията помага на децата да се фокусират върху активностите и да изграждат нови приятелства много по-бързо.`,
      },
      {
        q: "Как ще поддържаме контакт с детето?",
        a: "Децата имат достъп до телефон веднъж дневно — обикновено вечер. Родителите могат да се свържат с организаторите по всяко време на: +359 885 571 638.",
      },
      {
        q: "Трябва ли да дам лакомства и закуски?",
        a: "Не е необходимо, въпреки че е допустимо ако е важно за детето ви.",
      },
      {
        q: `Какво е пакетът "Take Home"?`,
        a: "Децата получават сувенири и подаръци, с които да помнят приятелствата и преживяванията от лагера.",
      },
      {
        q: "Как да задам допълнителни въпроси?",
