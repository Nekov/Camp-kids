          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                { title: "Малки групи, голям ефект", body: "Максимум 28 деца, ратио 1:6. Всеки педагог познава всяко дете. Индивидуалният подход не е обещание — той е структурна необходимост." },
              ].map((item) => (
