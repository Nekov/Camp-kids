        ...
        <section className="py-16 bg-cream border-y border-forest/10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="space-y-4 text-moss text-base leading-relaxed">
              ...
              <p>
                Намираме отговори и подкрепяме деца, млади хора и организации в техните проекти, желания и мечти — с обучение, информация, лични примери, срещи с успешни хора в различните сфери и не на последно място с финансиране. Ние сме приятелят, съветникът и настойникът в преследването на техните мечти.
              </p>
            </div>
          </div>
        </section>
