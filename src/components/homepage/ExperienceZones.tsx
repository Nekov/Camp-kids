const zones = [
  {
    ...
    desc: "Луксозни палатки с лична баня, климатик, удобни легла и WiFi. Природата среща комфорта.",
    detail: "Всяко дете има собствено легло и необходимото пространство. Личните санитарни помещения са важни за децата.",
  },
  {
    icon: "🍳",
