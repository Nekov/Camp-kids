        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-full bg-[#f5a623] flex items-center justify-center text-[#0d1b2a] font-bold">
                М
              </div>
              <div>
                <div className="font-bold text-white text-sm">Мечта в джоба</div>
            ...
            <div className="flex items-center gap-3 mt-4">
              <a
                ...
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#f5a623]/20 flex items-center justify-center text-white/70 hover:text-[#f5a623] transition-all"
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                <li key={s.slug}>
                  <Link href={`/programs/${s.slug}`} className="text-white/60 hover:text-[#f5a623] transition-colors">
                    {s.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-white/60 hover:text-[#f5a623] transition-colors">
                    {l.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="tel:+359885571638" className="flex items-center gap-2.5 text-white/60 hover:text-[#f5a623] transition-colors">
                  <Phone className="w-4 h-4 text-[#f5a623] shrink-0" />
                  0885 571 638
                </a>
              </li>
              <li>
                <a href="mailto:info@dreaminmypocket.org" className="flex items-center gap-2.5 text-white/60 hover:text-[#f5a623] transition-colors">
            ...
            <Link
              ...
              className="inline-block mt-5 bg-[#f5a623] hover:bg-[#f7b84a] text-[#0d1b2a] font-semibold text-sm px-5 py-2.5 rounded-full transition-all"
            >
              Запишете дете →
            </Link>
          </div>
